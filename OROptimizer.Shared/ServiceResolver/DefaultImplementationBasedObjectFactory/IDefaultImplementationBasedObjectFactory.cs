...
namespace OROptimizer.ServiceResolver.DefaultImplementationBasedObjectFactory
{
    ...
    public interface IDefaultImplementationBasedObjectFactory
    {
        ...
        ///// </summary>
        ///// <param name="typeToResolve">Resolved type.</param>
        ///// <param name="tryResolveConstructorParameterValueDelegate">A service provider.</param>
        ...
        ///// Otherwise, new instance of the type will be created every time it is injected.<br/>
        ...
        //object CreateInstance([NotNull] Type typeToResolve, [NotNull] TryResolveConstructorParameterValueDelegate tryResolveConstructorParameterValueDelegate,
        //    [NotNull] Func<Type, bool> resolvedTypeInstanceCanBeCached,
